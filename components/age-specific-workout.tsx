...
import { Clock, Calendar, Info, ChevronDown, ChevronUp, CheckCircle, TrendingUp } from "lucide-react"
...
export default function AgeSpecificWorkout() {
  const [activeTab, setActiveTab] = useState("60-69")
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold text-emerald-700 mb-6">Treinos Específicos por Faixa Etária</h1>

      <p className="text-lg mb-8">
        Selecione a faixa etária para visualizar um treino completo adaptado às necessidades específicas dessa idade.
        Cada treino foi cuidadosamente elaborado considerando as capacidades físicas típicas de cada grupo etário.
      </p>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-3 mb-8">
          <TabsTrigger value="60-69">60-69 anos</TabsTrigger>
          <TabsTrigger value="70-79">70-79 anos</TabsTrigger>
          <TabsTrigger value="80+">80+ anos</TabsTrigger>
        </TabsList>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-emerald-600">
                    {completedExercises.filter((id) => currentWorkout.exercises.includes(id)).length}/
